function onCreate()
	...
	makeAnimatedLuaSprite('mountainbop', 'mountainbop',-1150,-700)addAnimationByPrefix('mountainbop', 'mountainbop', 'mountainbop',50,true)
	objectPlayAnimation('mountainbop','mountainbop',false)	
	setScrollFactor('mountainbop', 0.8, 0.8);
	scaleLuaSprite('mountainbop', 2.7, 2.7);

	makeLuaSprite('hillback', 'hillback', -650, -900);
