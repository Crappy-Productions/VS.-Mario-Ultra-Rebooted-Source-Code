...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		char1 = new Character(700, 50, 'mario', true);
		char1.setGraphicSize(Std.int(char1.width * 0.8));
		add(char1);
		char1.visible = false;

		char2 = new Character(600, 100, 'luigi', false);
		char2.setGraphicSize(Std.int(char2.width * 0.8));
		add(char2);
		char2.visible = false;

		char3 = new Character(600, 420, 'bf', true);
		char3.setGraphicSize(Std.int(char2.width * 0.8));
		add(char3);
		char3.visible = false;

		char4 = new Character(520, 400, 'gf+peach', false);
		...
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "Friday Night Funkin': VS. Mario Ultra Rebooted DEMO", 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
